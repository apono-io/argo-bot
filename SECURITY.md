...
If you believe you have found a security vulnerability in `argo-bot`, please report
...
Security fixes are applied to the latest released version of `argo-bot`. We recommend
